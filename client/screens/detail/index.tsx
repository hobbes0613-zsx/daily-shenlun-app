...
import { View, Text, ScrollView, TouchableOpacity, ActivityIndicator, Alert, Modal, TouchableWithoutFeedback } from 'react-native';
                          ...
                          <View key={sIndex} className="mb-2 flex-wrap flex-row">
                            {chars.map((char, cIndex) => {
                              ...
                              const longPress = Gesture.LongPress()
                                .minDuration(300)
                                .onStart(() => {
                                  runOnJS(handleLongPress)(globalIndex);
                                });
                              ...
                              const pan = Gesture.Pan()
                                ...
                                .onUpdate((event) => {
                                  if (isSelecting && selectionStart !== null) {
                                    runOnJS(handleCharHover)(globalIndex);
                                  }
                                })
                                .onEnd(() => {
                                  if (isSelecting) {
                              ...
                              return (
                                <GestureDetector key={`${sIndex}-${cIndex}`} gesture={composed}>
                                  <View
                                    className={`rounded ${
